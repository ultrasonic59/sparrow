...
extern uint16_t get_adc_ram_dat(uint16_t i_offs);
...
extern int init_dac(uint8_t idat);
extern int set_spd_spi(uint8_t idat);
#define ON20DB	0x1
///=========================================
int main()
{
